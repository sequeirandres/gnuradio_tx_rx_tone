...
class fmcw_simulado_01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._gain_tx_range = Range(0, 30, 1, 10, 200)
        ...
        self._gain_rx_range = Range(0, 30, 1, 10, 200)
        ...
        self.blocks_throttle_1_0 = blocks.throttle(gr.sizeof_gr_complex*1, 1E6,True)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 100e3, 1, 0, 0)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_throttle_1_0_0_0, 0))
        ...
        self.connect((self.hilbert_fc_0, 0), (self.blocks_throttle_1_0, 0))
